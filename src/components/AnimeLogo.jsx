...
class NeonJobs extends React.Component {
    render() {
        return (
            <svg
            ...
            >
                ...
                <defs>
                    ...
                    >
                        ...
                        <stop offset={0} style={{ stopColor: 'rgb(236,103,238)', stopOpacity: 1 }} />
                        <stop offset={1} style={{ stopColor: 'rgb(248,83,118)', stopOpacity: 1 }} />
                    </linearGradient>
                    <linearGradient
                        id="_Linear2"
                        x1={0}
                    ...
                    >
                        <stop offset={0} style={{ stopColor: 'rgb(255,195,0)', stopOpacity: 1 }} />
                        <stop offset={1} style={{ stopColor: 'rgb(235,122,44)', stopOpacity: 1 }} />
                    </linearGradient>
                    <linearGradient
                        id="_Linear11"
                        x1={0}
                    ...
                    >
                        <stop offset={0} style={{ stopColor: 'rgb(0,255,219)', stopOpacity: 1 }} />
                        <stop offset={1} style={{ stopColor: 'rgb(87,173,223)', stopOpacity: 1 }} />
                    </linearGradient>
                    <linearGradient
                        id="_Linear35"
                        x1={0}
                    ...
                    >
                        <stop offset={0} style={{ stopColor: 'rgb(150,255,0)', stopOpacity: 1 }} />
                        <stop offset={1} style={{ stopColor: 'rgb(59,190,52)', stopOpacity: 1 }} />
                    </linearGradient>
                    <linearGradient
                        id="_Linear45"
                        x1={0}
